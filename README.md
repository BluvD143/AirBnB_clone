...
The console is the initial component of the AirBnB project, which will cover essential ideas of higher level programming as a whole. The purpose of the AirBnB project is to eventually launch our server, which will be a basic replica of the AirBnB website (HBnB). To handle items for the AirBnB(HBnB) website, a command interpreter is constructed.
...
## Authors
* **Bello Abayomi Afeez** <[BluvD143](https://github.com/BluvD143)>
* **Fadlullah Abdulsalaam** <[salamPhard](https://github.com/salamPhard)>
